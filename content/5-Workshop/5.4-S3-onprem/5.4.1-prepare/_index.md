...
![route 53 diagram](/internship-report/images/5-Workshop/5.4-S3-onprem/route53.png)
...
![Create stack](/internship-report/images/5-Workshop/5.4-S3-onprem/create-stack.png)

![Button](/internship-report/images/5-Workshop/5.4-S3-onprem/create-stack-button.png)
...
![ec2 id](/internship-report/images/5-Workshop/5.4-S3-onprem/ec2-onprem-id.png)
...
![rt](/internship-report/images/5-Workshop/5.4-S3-onprem/rt.png)

5. Click Add route.
+ Destination: your Cloud VPC cidr range
+ Target: ID of your infra-vpngw-test instance (you saved in your editor at step 1)

![add route](/internship-report/images/5-Workshop/5.4-S3-onprem/add-route.png)
