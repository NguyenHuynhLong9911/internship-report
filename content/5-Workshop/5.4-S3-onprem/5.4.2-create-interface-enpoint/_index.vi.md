...
![name](/internship-report/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint1.png)
...
![service](/internship-report/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint2.png)
...
![vpc](/internship-report/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint3.png)

5. Chọn 2 subnets trong AZs sau: us-east-1a and us-east-1b

![subnets](/internship-report/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint4.png)

6. Đối với Security group, chọn SGforS3Endpoint:

![sg](/internship-report/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint5.png)

7. Giữ default policy - full access và click Create endpoint

![success](/internship-report/images/5-Workshop/5.4-S3-onprem/s3-interface-endpoint-success.png)
