...
![SmartStudy HTTP APIs](/internship-report/images/5-Workshop/5.3-Infrastructure/api-gateway.png)
...
![SmartStudy Lambda functions](/internship-report/images/5-Workshop/5.3-Infrastructure/lambda-functions.png)
...
![SmartStudy S3 buckets](/internship-report/images/5-Workshop/5.3-Infrastructure/s3-buckets.png)
...
![SmartStudy SQS queues](/internship-report/images/5-Workshop/5.3-Infrastructure/sqs-queues.png)
...
![SmartStudy DynamoDB tables - first view](/internship-report/images/5-Workshop/5.3-Infrastructure/dynamodb-tables-1.png)

*Figure 5.14: Production tables and the first group of staging tables.*

![SmartStudy DynamoDB tables - second view](/internship-report/images/5-Workshop/5.3-Infrastructure/dynamodb-tables-2.png)
