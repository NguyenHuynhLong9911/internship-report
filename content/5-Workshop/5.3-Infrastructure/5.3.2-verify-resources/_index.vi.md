...
![Các HTTP API của SmartStudy](/internship-report/images/5-Workshop/5.3-Infrastructure/api-gateway.png)
...
![Các Lambda function của SmartStudy](/internship-report/images/5-Workshop/5.3-Infrastructure/lambda-functions.png)
...
![Các S3 bucket của SmartStudy](/internship-report/images/5-Workshop/5.3-Infrastructure/s3-buckets.png)
...
![Các SQS queue của SmartStudy](/internship-report/images/5-Workshop/5.3-Infrastructure/sqs-queues.png)
...
![Các bảng DynamoDB của SmartStudy - phần một](/internship-report/images/5-Workshop/5.3-Infrastructure/dynamodb-tables-1.png)

*Hình 5.14: Các bảng production và nhóm bảng staging đầu tiên.*

![Các bảng DynamoDB của SmartStudy - phần hai](/internship-report/images/5-Workshop/5.3-Infrastructure/dynamodb-tables-2.png)
