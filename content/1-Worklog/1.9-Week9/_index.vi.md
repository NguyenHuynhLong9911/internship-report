...
* Phân chia công việc phát triển trong nhóm.
* Bắt đầu xây dựng frontend và backend.
* Thiết lập hosting cho website bằng AWS Amplify.
...
* Nhóm bắt đầu phát triển SmartStudy theo công việc đã phân chia.
* Frontend, backend và môi trường hosting Amplify đã được khởi tạo.
